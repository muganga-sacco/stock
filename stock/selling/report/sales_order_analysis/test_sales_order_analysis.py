...
from stock.selling.doctype.sales_order.sales_order import make_delivery_note, make_sales_invoice
from stock.selling.doctype.sales_order.test_sales_order import make_sales_order
from stock.selling.report.sales_order_analysis.sales_order_analysis import execute
