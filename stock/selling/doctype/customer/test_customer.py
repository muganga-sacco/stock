...
from stock.accounts.party import get_due_date
from stock.exceptions import PartyDisabled, PartyFrozen
from stock.selling.doctype.customer.customer import (
	get_credit_limit,
	get_customer_outstanding,
	parse_full_name,
)
from stock.tests.utils import create_test_contact_and_address
...
class TestCustomer(FrappeTestCase):
	...
	def test_party_details(self):
		from stock.accounts.party import get_party_details
	...
	def test_serach_fields_for_customer(self):
		from stock.controllers.queries import customer_query
