...
from stock.controllers.accounts_controller import update_child_qty_rate
from stock.maintenance.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from stock.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
	make_maintenance_visit,
)
from stock.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order
from stock.selling.doctype.product_bundle.test_product_bundle import make_product_bundle
from stock.selling.doctype.sales_order.sales_order import (
	WarehouseRequired,
	make_delivery_note,
...
from stock.stock.doctype.item.test_item import make_item
...
class TestSalesOrder(FrappeTestCase):
	...
	def test_so_billed_amount_against_return_entry(self):
		from stock.accounts.doctype.sales_invoice.sales_invoice import make_sales_return
	...
	def test_drop_shipping(self):
		from stock.buying.doctype.purchase_order.purchase_order import update_status
		from stock.selling.doctype.sales_order.sales_order import (
			make_purchase_order_for_default_supplier,
		)
		from stock.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_product_bundles_in_so_are_replaced_with_bundle_items_in_po(self):
		...
		"""
		from stock.selling.doctype.sales_order.sales_order import make_purchase_order
	...
	def test_make_work_order(self):
		from stock.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_advance_payment_entry_unlink_against_sales_order(self):
		from stock.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
	...
	def test_work_order_pop_up_from_sales_order(self):
		...
		from stock.controllers.item_variant import create_variant
		from stock.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from stock.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_cancellation_after_work_order_submission(self):
		...
		Expected result: Sales Order should not get cancelled
		"""
		from stock.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from stock.manufacturing.doctype.work_order.work_order import (
			make_stock_entry as make_se_from_wo,
		)
		from stock.stock.doctype.material_request.material_request import raise_work_orders
	...
	def test_sales_order_with_shipping_rule(self):
		from stock.accounts.doctype.shipping_rule.test_shipping_rule import create_shipping_rule
	...
	def test_sales_order_partial_advance_payment(self):
		...
		from stock.selling.doctype.customer.test_customer import get_customer_dict
