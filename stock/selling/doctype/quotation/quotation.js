...
stock.pre_sales.set_as_lost("Quotation");
...
stock.selling.QuotationController = class QuotationController extends stock.selling.SellingController {
	onload(doc, dt, dn) {
			...
			this.frm.add_custom_button(__('Opportunity'),
				function() {
					stock.utils.map_current_doc({
						method: "stock.crm.doctype.opportunity.opportunity.make_quotation",
	...
	get_lead_details() {
		...
		frappe.call({
			method: "stock.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(stock.selling.QuotationController);
