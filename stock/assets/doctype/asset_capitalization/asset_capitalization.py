...
import stock
from stock.assets.doctype.asset.asset import get_asset_value_after_depreciation
from stock.assets.doctype.asset.depreciation import (
	depreciate_asset,
...
from stock.stock.utils import get_incoming_rate
...
class AssetCapitalization(StockController):
	...
	if TYPE_CHECKING:
		...
		from stock.assets.doctype.asset_capitalization_asset_item.asset_capitalization_asset_item import (
			AssetCapitalizationAssetItem,
		)
		from stock.assets.doctype.asset_capitalization_service_item.asset_capitalization_service_item import (
			AssetCapitalizationServiceItem,
		)
		from stock.assets.doctype.asset_capitalization_stock_item.asset_capitalization_stock_item import (
		...
		for item_row in self.stock_items:
			...
			if sle_list:
				for sle in sle_list:
					...
					if stock.is_perpetual_inventory_enabled(self.company):
