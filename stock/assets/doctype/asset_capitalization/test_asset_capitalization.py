...
from stock.assets.doctype.asset.depreciation import post_depreciation_entries
from stock.assets.doctype.asset.test_asset import (
	create_asset,
	create_asset_data,
	set_depreciation_settings_in_company,
)
from stock.assets.doctype.asset_depreciation_schedule.asset_depreciation_schedule import (
