(() => {
  ...
  // ../stock/stock/public/js/bom_configurator/bom_configurator.bundle.js
  var BOMConfigurator = class {
    ...
    get_sub_assembly_modal_fields(read_only = false) {
      return [
        { label: __("Sub Assembly Item"), fieldname: "item_code", fieldtype: "Link", options: "Item", reqd: 1, read_only },
        { fieldtype: "Column Break" },
        { label: __("Qty"), fieldname: "qty", default: 1, fieldtype: "Float", reqd: 1, read_only },
        { fieldtype: "Section Break" },
        {
          ...
          fields: [
            ...
            { label: __("Qty"), fieldname: "qty", default: 1, fieldtype: "Float", reqd: 1, in_list_view: 1 }
          ]
        }
      ];
    }
...
//# sourceMappingURL=bom_configurator.bundle.HVMUFS4B.js.map
