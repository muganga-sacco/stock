(() => {
  // frappe-html:/Users/abizeyimanavictor/frappe-msacco/apps/stock/stock/stock/dashboard/item_dashboard.html
...
`;
  ...
  // frappe-html:/Users/abizeyimanavictor/frappe-msacco/apps/stock/stock/stock/dashboard/item_dashboard_list.html
...
`;
  ...
  // ../stock/stock/stock/dashboard/item_dashboard.js
  frappe.provide("stock.stock");
  stock.stock.ItemDashboard = class ItemDashboard {
    constructor(opts) {
      $.extend(this, opts);
      this.make();
    }
      ...
      function handle_move_add(element, action) {
        ...
        if (disable_quick_entry) {
          ...
          if (action === "Add") {
            ...
            stock.stock.move_item(item, null, warehouse, actual_qty, rate, function() {
              me.refresh();
            });
          } else {
            stock.stock.move_item(item, warehouse, null, actual_qty, null, function() {
              me.refresh();
            });
          }
        }
  ...
  stock.stock.move_item = function(item, source, target, actual_qty, rate, callback) {
  ...
  // frappe-html:/Users/abizeyimanavictor/frappe-msacco/apps/stock/stock/stock/page/warehouse_capacity_summary/warehouse_capacity_summary.html
...
`;
  ...
  // frappe-html:/Users/abizeyimanavictor/frappe-msacco/apps/stock/stock/stock/page/warehouse_capacity_summary/warehouse_capacity_summary_header.html
...
//# sourceMappingURL=item-dashboard.bundle.WTYP2PX4.js.map
