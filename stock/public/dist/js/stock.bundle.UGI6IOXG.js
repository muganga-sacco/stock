(() => {
  ...
  $.extend(stock.utils, {
    ...
    get_terms: function(tc_name, doc, callback) {
      if (tc_name) {
        return frappe.call({
          method: "basic.setup.doctype.terms_and_conditions.terms_and_conditions.get_terms_and_conditions",
          args: {
    ...
    add_inventory_dimensions: function(report_name, index) {
      ...
      frappe.call({
        method: "stock.stock.doctype.inventory_dimension.inventory_dimension.get_inventory_dimensions",
        callback: function(r) {
        ...
        { fieldtype: "Section Break", label: __("Items") },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              get_query: (e) => {
                return {
                  query: "stock.stock.doctype.item_alternative.item_alternative.get_alternative_items",
                  filters: {
      ...
      frappe.ui.form.on(d, {
        onload: function(frm) {
          if (!frm.doc.service_level_agreement)
            return;
          frappe.call({
            method: "stock.support.doctype.service_level_agreement.service_level_agreement.get_service_level_agreement_filters",
            args: {
        ...
        refresh: function(frm) {
          if (frm.doc.status !== "Closed" && frm.doc.service_level_agreement && ["First Response Due", "Resolution Due"].includes(
  ...
  stock.utils.get_party_details = function(frm, method, args, callback) {
    ...
    if (frappe.meta.get_docfield(frm.doc.doctype, "taxes")) {
      if (!stock.utils.validate_mandatory(
        frm,
  ...
  stock.TransactionController = class TransactionController extends stock.taxes_and_totals {
    setup() {
      super.setup();
      let me = this;
    ...
    apply_default_taxes() {
      ...
      if (taxes_and_charges_field) {
        return frappe.call({
          method: "stock.controllers.accounts_controller.get_default_taxes_and_charges",
          args: {
                ...
                frappe.run_serially([
                  ...
                  () => {
                    if (show_batch_dialog && !frappe.flags.trigger_from_barcode_scanner)
                      return frappe.db.get_value("Item", item.item_code, [
                        "has_batch_no",
                        "has_serial_no"
                      ]).then((r2) => {
    ...
    serial_no(doc, cdt, cdn) {
      ...
      if (item && item.serial_no) {
        if (!item.item_code) {
          ...
          if (!doc.is_return && cint(
            frappe.user_defaults.set_qty_in_transactions_based_on_serial_no_input
          )) {
            setTimeout(() => {
    ...
    company() {
      ...
      if (frappe.meta.get_docfield(this.frm.doctype, "shipping_address") && in_list(
    ...
    get_exchange_rate(transaction_date, from_currency, to_currency, callback) {
      var args;
      if (["Quotation", "Sales Order", "Delivery Note", "Sales Invoice"].includes(
        this.frm.doctype
      )) {
        args = "for_selling";
      } else if (["Purchase Order", "Purchase Receipt", "Purchase Invoice"].includes(
        this.frm.doctype
      )) {
        args = "for_buying";
      }
    ...
    toggle_conversion_factor(item) {
      if (this.frm.get_field("items").grid.fields_map.conversion_factor) {
        this.frm.fields_dict.items.grid.toggle_enable(
          "conversion_factor",
          item.uom != item.stock_uom && !frappe.meta.get_docfield(
    ...
    _get_args(item) {
      ...
      return {
        ...
        update_stock: in_list(
          ...
          me.frm.doc.doctype
        ) ? cint(me.frm.doc.update_stock) : 0,
    ...
    payment_term(doc, cdt, cdn) {
      ...
      if (row.payment_term) {
        frappe.call({
          method: "stock.controllers.accounts_controller.get_payment_term_details",
          args: {
  ...
  stock.show_serial_batch_selector = function(frm, item_row, callback, on_close, show_dialog) {
  ...
  // frappe-html:/Users/abizeyimanavictor/frappe-msacco/apps/stock/stock/public/js/templates/item_selector.html
...
`;
  ...
  // frappe-html:/Users/abizeyimanavictor/frappe-msacco/apps/stock/stock/public/js/templates/item_quick_entry.html
...
`;
  ...
  // frappe-html:/Users/abizeyimanavictor/frappe-msacco/apps/stock/stock/public/js/templates/call_link.html
...
`;
  ...
  // frappe-html:/Users/abizeyimanavictor/frappe-msacco/apps/stock/stock/public/js/templates/crm_activities.html
...
.form-footer {
  ...
  // frappe-html:/Users/abizeyimanavictor/frappe-msacco/apps/stock/stock/public/js/templates/crm_notes.html
  ...
  stock.financial_statements = {
    ...
    "formatter": function(value, row, column, data, default_formatter, filter) {
      ...
      if (data && column.fieldname == "account") {
        ...
        if (data.account) {
          column.link_onclick = "stock.financial_statements.open_general_ledger(" + JSON.stringify(data) + ")";
        }
        column.is_tree = true;
      }
...
//# sourceMappingURL=stock.bundle.UGI6IOXG.js.map
