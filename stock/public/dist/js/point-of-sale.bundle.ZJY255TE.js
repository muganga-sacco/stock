(() => {
  ...
  // ../stock/stock/selling/page/point_of_sale/pos_item_selector.js
  var import_onscan = __toESM(require_onscan());
  stock.PointOfSale.ItemSelector = class {
    ...
    get_items({ start = 0, page_length = 40, search_term = "" }) {
      ...
      return frappe.call({
        method: "stock.selling.page.point_of_sale.point_of_sale.get_items",
        freeze: true,
    ...
    make_search_bar() {
      ...
      this.item_group_field = frappe.ui.form.make_control({
        df: {
          ...
          get_query: function() {
            return {
              query: "stock.selling.page.point_of_sale.point_of_sale.item_group_query",
              filters: {
  ...
  // ../stock/stock/selling/page/point_of_sale/pos_item_cart.js
  stock.PointOfSale.ItemCart = class {
    ...
    make_cart_numpad() {
      ...
      this.number_pad = new stock.PointOfSale.NumberPad({
    ...
    make_customer_selector() {
      this.$customer_section.html(`
		...
		`);
      const me = this;
      const query = { query: "stock.controllers.queries.customer_query" };
      ...
      if (customer) {
        return new Promise((resolve) => {
          frappe.db.get_value("Customer", customer, ["email_id", "mobile_no", "image", "loyalty_program"]).then(({ message }) => {
            ...
            if (loyalty_program) {
              frappe.call({
                method: "stock.accounts.doctype.loyalty_program.loyalty_program.get_loyalty_program_details_with_points",
    ...
    render_customer_fields() {
      ...
      function handle_customer_field_change() {
        ...
        if (this.value && current_value != this.value && this.df.fieldname != "loyalty_points") {
          frappe.call({
            method: "stock.selling.page.point_of_sale.point_of_sale.set_customer_info",
            args: {
  ...
  // ../stock/stock/selling/page/point_of_sale/pos_item_details.js
  stock.PointOfSale.ItemDetails = class {
    constructor({ wrapper, events, settings }) {
      this.wrapper = wrapper;
      this.events = events;
      this.hide_images = settings.hide_images;
...
`);
    ...
    bind_auto_serial_fetch_event() {
      this.$form_container.on("click", ".auto-fetch-btn", () => {
        frappe.require("assets/stock/js/utils/serial_no_batch_selector.js", () => {
  ...
  // ../stock/stock/selling/page/point_of_sale/pos_number_pad.js
  stock.PointOfSale.NumberPad = class {
  ...
  // ../stock/stock/selling/page/point_of_sale/pos_payment.js
  stock.PointOfSale.Payment = class {
  ...
  // ../stock/stock/selling/page/point_of_sale/pos_past_order_list.js
  stock.PointOfSale.PastOrderList = class {
...
Return`,
    ...
    refresh_list() {
      ...
      return frappe.call({
        method: "stock.selling.page.point_of_sale.point_of_sale.get_past_order_list",
        freeze: true,
  ...
  // ../stock/stock/selling/page/point_of_sale/pos_past_order_summary.js
  stock.PointOfSale.PastOrderSummary = class {
    constructor({ wrapper, events }) {
      this.wrapper = wrapper;
      this.events = events;
      this.init_component();
  ...
  // ../stock/stock/selling/page/point_of_sale/pos_controller.js
  stock.PointOfSale.Controller = class {
    constructor(wrapper) {
    ...
    fetch_opening_entry() {
      return frappe.call("stock.selling.page.point_of_sale.point_of_sale.check_opening_entry", { "user": frappe.session.user });
    }
    check_opening_entry() {
    ...
    create_opening_voucher() {
      ...
      const dialog = new frappe.ui.Dialog({
        ...
        primary_action: async function({ company, pos_profile, balance_details }) {
          ...
          const method = "stock.selling.page.point_of_sale.point_of_sale.create_opening_voucher";
      ...
      const pos_profile_query = () => {
        return {
          query: "stock.accounts.doctype.pos_profile.pos_profile.pos_profile_query",
    ...
    async prepare_app_defaults(data) {
      ...
      frappe.call({
        method: "stock.selling.page.point_of_sale.point_of_sale.get_pos_profile_data",
    ...
    init_item_selector() {
      this.item_selector = new stock.PointOfSale.ItemSelector({
    ...
    init_item_cart() {
      this.cart = new stock.PointOfSale.ItemCart({
        wrapper: this.$components_wrapper,
        settings: this.settings,
        events: {
          get_frm: () => this.frm,
    ...
    init_item_details() {
      this.item_details = new stock.PointOfSale.ItemDetails({
        wrapper: this.$components_wrapper,
        settings: this.settings,
        events: {
          get_frm: () => this.frm,
...
`);
    ...
    init_payments() {
      this.payment = new stock.PointOfSale.Payment({
        wrapper: this.$components_wrapper,
        events: {
          get_frm: () => this.frm || {},
    ...
    init_recent_order_list() {
      this.recent_order_list = new stock.PointOfSale.PastOrderList({
        wrapper: this.$components_wrapper,
        events: {
    ...
    init_order_summary() {
      this.order_summary = new stock.PointOfSale.PastOrderSummary({
        wrapper: this.$components_wrapper,
        events: {
          get_frm: () => this.frm,
          process_return: (name) => {
    ...
    async make_return_invoice(doc) {
      ...
      this.frm.doc.items = [];
      return frappe.call({
        method: "stock.accounts.doctype.pos_invoice.pos_invoice.make_sales_return",
        args: {
...
`).length || 0;
    ...
    async check_serial_no_availablilty(item_code, warehouse, serial_no) {
      const method = "stock.stock.doctype.serial_no.serial_no.get_pos_reserved_serial_nos";
    ...
    get_available_stock(item_code, warehouse) {
      const me = this;
      return frappe.call({
        method: "stock.accounts.doctype.pos_invoice.pos_invoice.get_stock_availability",
        args: {
          "item_code": item_code,
          "warehouse": warehouse
        },
...
//# sourceMappingURL=point-of-sale.bundle.ZJY255TE.js.map
