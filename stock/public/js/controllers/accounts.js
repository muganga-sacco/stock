...
// get tax rate
// frappe.provide("stock.taxes");

// stock.accounts.taxes = {
...
// 						return {
// 							query: "stock.controllers.queries.tax_account_query",
// 							filters: {
...
// 					frappe.call({
// 						type:"GET",
// 						method: "stock.controllers.accounts_controller.get_tax_rate",
...
// stock.accounts.payment_triggers = {
...
// 		return  frappe.call({
// 			method: "stock.accounts.doctype.sales_invoice.sales_invoice.get_bank_cash_account",
// 			args: {
