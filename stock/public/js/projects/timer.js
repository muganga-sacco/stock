frappe.provide("stock.timesheet");

stock.timesheet.timer = function(frm, row, timestamp=0) {
	...
	stock.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

stock.timesheet.control_timer = function(frm, dialog, row, timestamp=0) {
