// frappe.provide("stock.accounts.bank_reconciliation");

// stock.accounts.bank_reconciliation.DialogManager = class DialogManager {
...
// 		frappe.call({
// 			method:
// 				"stock.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.get_linked_payments",
// 			args: {
...
// 		frappe.call({
// 			method: "stock.accounts.doctype.bank_transaction.bank_transaction.get_doctypes_for_bank_reconciliation",
// 			callback: (r) => {
...
// 		frappe.call({
// 			method:
// 				"stock.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.reconcile_vouchers",
// 			args: {
...
// 		frappe.call({
// 			method:
// 				"stock.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.create_payment_entry_bts",
// 			args: {
// 				bank_transaction_name: this.bank_transaction.name,
...
// 		frappe.call({
// 			method:
// 				"stock.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.create_journal_entry_bts",
// 			args: {
// 				bank_transaction_name: this.bank_transaction.name,
// 				reference_number: values.reference_number,
// 				reference_date: values.reference_date,
...
// 		frappe.call({
// 			method:
// 				"stock.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.update_bank_transaction",
// 			args: {
// 				bank_transaction_name: this.bank_transaction.name,
// 				reference_number: values.reference_number,
// 				party_type: values.party_type,
