...
// stock.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
// 	constructor(opts) {
...
// 			let number_card = new stock.accounts.NumberCard(summary);
...
// stock.accounts.NumberCard = class NumberCard {
// 	constructor(options) {
