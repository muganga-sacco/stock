...
// 		let me = this;
// 		frappe.call({
// 			method: "stock.accounts.doctype.accounting_dimension.accounting_dimension.get_dimensions",
// 			args: {
...
// 					return stock.queries.get_filtered_dimensions(row, fields, dimension, doc.company);
// 				});
// 			});
// 		}
// 	},
...
// 			return stock.queries.get_filtered_dimensions(doc, fields, dimension, doc.company);
// 		});
// 	},
