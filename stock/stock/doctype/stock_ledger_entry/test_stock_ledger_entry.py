...
from stock.accounts.doctype.gl_entry.gl_entry import rename_gle_sle_docs
...
from stock.stock.doctype.stock_ledger_entry.stock_ledger_entry import BackDatedStockTransaction
...
from stock.stock.tests.test_utils import StockTestMixin
...
class TestStockLedgerEntry(FrappeTestCase, StockTestMixin):
	...
	def test_negative_qty_with_precision(self):
		...
		from stock.stock.doctype.item.test_item import create_item
		from stock.stock.utils import get_stock_balance
...
def setup_item_valuation_test(
	...
	from stock.stock.doctype.batch.batch import make_batch
	from stock.stock.doctype.item.test_item import make_item
...
def create_delivery_note_entries_for_batchwise_item_valuation_test(dn_entry_list):
	...
	from stock.selling.doctype.sales_order.test_sales_order import make_sales_order
