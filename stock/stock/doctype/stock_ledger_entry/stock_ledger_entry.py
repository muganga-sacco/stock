...
from stock.controllers.item_variant import ItemTemplateCannotHaveStock
from stock.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
from stock.stock.serial_batch_bundle import SerialBatchBundle
...
class StockLedgerEntry(Document):
	...
	def block_transactions_against_group_warehouse(self):
		from stock.stock.utils import is_group_warehouse
