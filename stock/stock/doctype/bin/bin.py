...
class Bin(Document):
	...
	def update_reserved_qty_for_production_plan(self, skip_project_qty_update=False):
		...
		from stock.manufacturing.doctype.production_plan.production_plan import (
	...
	def update_reserved_qty_for_production(self):
		...
		in open work orders"""
		from stock.manufacturing.doctype.work_order.work_order import get_reserved_qty_for_production
