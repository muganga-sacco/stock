...
from stock.accounts.doctype.account.test_account import create_account, get_inventory_account
...
from stock.assets.doctype.asset.test_asset import create_asset_category, create_fixed_asset_item
...
class TestLandedCostVoucher(FrappeTestCase):
	...
	def test_multi_currency_lcv(self):
		from hrms.setup.doctype.currency_exchange.test_currency_exchange import (
			save_new_records,
			test_records,
		)
