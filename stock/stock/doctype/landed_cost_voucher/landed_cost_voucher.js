...
stock.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
stock.stock.LandedCostVoucher = class LandedCostVoucher extends stock.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(stock.stock.LandedCostVoucher);
