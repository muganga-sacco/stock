...
frappe.ui.form.on('Company', {
  ...
  setup: function (frm) {
    ...
    // stock.company.setup_queries(frm);
    ...
    frappe.verify_password(function () {
      var d = frappe.prompt(
        ...
        function (data) {
          ...
          frappe.call({
            method:
              'stock.setup.doctype.company.company.create_transaction_deletion_request',
            args: {
...
stock.company.setup_queries = function (frm) {
  $.each(
    [
    ...
    function (i, v) {
      stock.company.set_custom_query(frm, v);
    }
  );
...
stock.company.set_custom_query = function (frm, v) {
  var filters = {
    company: frm.doc.name,
    is_group: 0,
  };
