      ...
      frm.add_custom_button(
        ...
        function () {
          frappe.model.open_mapped_doc({
            method:
              'stock.stock.doctype.delivery_note.delivery_note.make_sales_invoice',
            frm: cur_frm,
          });
        },
        __('Create')
      ...
      if (internal) {
        ...
        frm.add_custom_button(
          ...
          function () {
            frappe.model.open_mapped_doc({
              method:
                'stock.stock.doctype.delivery_note.delivery_note.make_inter_company_purchase_receipt',
              frm: frm,
            });
          },
          __('Create')
...
stock.stock.DeliveryNoteController = class DeliveryNoteController extends (
  stock.selling.SellingController
) {
  setup(doc) {
        ...
        this.frm.add_custom_button(
          ...
          function () {
            ...
            stock.utils.map_current_doc({
              method:
                'stock.selling.doctype.sales_order.sales_order.make_delivery_note',
              args: {
        ...
        if (doc.__onload && doc.__onload.has_unpacked_items) {
          this.frm.add_custom_button(
            ...
            function () {
              frappe.model.open_mapped_doc({
                method:
                  'stock.stock.doctype.delivery_note.delivery_note.make_packing_slip',
                frm: me.frm,
              });
            },
            __('Create')
  ...
  make_installation_note() {
    frappe.model.open_mapped_doc({
      method:
        'stock.stock.doctype.delivery_note.delivery_note.make_installation_note',
      frm: this.frm,
    });
  }
  ...
  make_sales_return() {
    frappe.model.open_mapped_doc({
      method:
        'stock.stock.doctype.delivery_note.delivery_note.make_sales_return',
      frm: this.frm,
    });
  }
  ...
  make_delivery_trip() {
    frappe.model.open_mapped_doc({
      method:
        'stock.stock.doctype.delivery_note.delivery_note.make_delivery_trip',
      frm: cur_frm,
    });
  }
  ...
  update_status(status) {
    ...
    frappe.call({
      method:
        'stock.stock.doctype.delivery_note.delivery_note.update_delivery_note_status',
...
extend_cscript(
  cur_frm.cscript,
  new stock.stock.DeliveryNoteController({ frm: cur_frm })
);
