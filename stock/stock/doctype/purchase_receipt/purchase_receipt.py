...
import stock
from stock.assets.doctype.asset.asset import get_asset_account, is_cwip_accounting_enabled
...
class PurchaseReceipt(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from stock.buying.doctype.purchase_receipt_item_supplied.purchase_receipt_item_supplied import (
			PurchaseReceiptItemSupplied,
		)
		from stock.stock.doctype.purchase_receipt_item.purchase_receipt_item import PurchaseReceiptItem
	...
	# 	from stock.accounts.general_ledger import process_gl_map
