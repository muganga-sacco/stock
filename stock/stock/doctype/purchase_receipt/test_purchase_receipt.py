...
import stock
from stock.accounts.doctype.account.test_account import get_inventory_account
from stock.controllers.buying_controller import QtyMismatchError
from stock.stock.doctype.item.test_item import create_item, make_item
from stock.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice
from stock.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import (
	SerialNoDuplicateError,
	SerialNoExistsInFutureTransactionError,
)
from stock.stock.doctype.serial_and_batch_bundle.test_serial_and_batch_bundle import (
...
from stock.stock.stock_ledger import SerialNoExistsInFutureTransaction
...
class TestPurchaseReceipt(FrappeTestCase):
	...
	def test_make_purchase_invoice(self):
		from stock.accounts.doctype.payment_entry.test_payment_entry import create_payment_term
	...
	def test_purchase_receipt_no_gl_entry(self):
		from stock.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
	...
	def test_duplicate_serial_nos(self):
		from stock.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
	...
	def test_purchase_receipt_gl_entry(self):
		...
		self.assertEqual(cint(stock.is_perpetual_inventory_enabled(pr.company)), 1)
	...
	def test_purchase_return_partial(self):
		...
		from stock.controllers.sales_and_purchase_return import make_return_doc
	...
	def test_purchase_return_for_rejected_qty(self):
		from stock.stock.doctype.warehouse.test_warehouse import get_warehouse
	...
	def test_closed_purchase_receipt(self):
		from stock.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_pr_billing_status(self):
		...
		3. PO -> PR2.
		"""
		from stock.buying.doctype.purchase_order.purchase_order import (
		...
		from stock.buying.doctype.purchase_order.test_purchase_order import create_purchase_order
	...
	def test_purchase_return_with_submitted_asset(self):
		from stock.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_return
	...
	def test_purchase_receipt_cost_center(self):
		from stock.accounts.doctype.cost_center.test_cost_center import create_cost_center
	...
	def test_make_purchase_invoice_from_pr_for_returned_qty(self):
		from stock.buying.doctype.purchase_order.test_purchase_order import (
	...
	def test_stock_transfer_from_purchase_receipt(self):
		from stock.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from stock.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
	...
	def test_po_to_pi_and_po_to_pr_worflow_full(self):
		...
		"""
		from stock.buying.doctype.purchase_order import purchase_order, test_purchase_order
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		from stock.accounts.doctype.purchase_invoice.purchase_invoice import (
			make_purchase_receipt as create_purchase_receipt,
		)
		from stock.accounts.doctype.purchase_invoice.test_purchase_invoice import (
			make_purchase_invoice as create_purchase_invoice,
		)
		from stock.accounts.party import add_party_account
	...
	def test_payment_terms_are_fetched_when_creating_purchase_invoice(self):
		from stock.accounts.doctype.payment_entry.test_payment_entry import (
		...
		from stock.selling.doctype.sales_order.test_sales_order import (
	...
	def test_neg_to_positive(self):
		from stock.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry
	...
	def test_backdated_transaction_for_internal_transfer_in_trasit_warehouse_for_purchase_invoice(
		...
		from stock.accounts.doctype.sales_invoice.sales_invoice import (
			make_inter_company_purchase_invoice,
		)
		from stock.accounts.doctype.sales_invoice.test_sales_invoice import create_sales_invoice
	...
	def test_disable_last_purchase_rate(self):
		from stock.stock.get_item_details import get_item_details
	...
	def test_validate_received_qty_for_internal_pr(self):
		...
		from stock.controllers.status_updater import OverAllowanceError
		from stock.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
	...
	def test_internal_pr_gl_entries(self):
		...
		from stock.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from stock.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
		from stock.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
	...
	def test_purchase_receipt_with_backdated_landed_cost_voucher(self):
		from stock.controllers.sales_and_purchase_return import make_return_doc
		from stock.stock.doctype.landed_cost_voucher.test_landed_cost_voucher import (
	...
	def test_purchase_receipt_provisional_accounting(self):
		...
		from stock.buying.doctype.supplier.test_supplier import create_supplier

		supplier = create_supplier(default_currency="USD")

		# Step - 2: Setup Company for Provisional Accounting
		from stock.accounts.doctype.account.test_account import create_account
...
def prepare_data_for_internal_transfer():
	from stock.accounts.doctype.sales_invoice.test_sales_invoice import create_internal_supplier
	from stock.selling.doctype.customer.test_customer import create_internal_customer
