...
from stock.stock.doctype.warehouse.warehouse import convert_to_group_or_ledger, get_children
...
def create_warehouse(warehouse_name, properties=None, company=None):
	...
	warehouse_id = stock.encode_company_abbr(warehouse_name, company)
