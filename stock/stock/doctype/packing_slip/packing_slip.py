...
from stock.controllers.status_updater import StatusUpdater
...
class PackingSlip(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from stock.stock.doctype.packing_slip_item.packing_slip_item import PackingSlipItem
	...
	def validate(self) -> None:
		from stock.utilities.transaction_base import validate_uom_is_integer
...
def item_details(doctype, txt, searchfield, start, page_len, filters):
	from stock.controllers.queries import get_match_cond
