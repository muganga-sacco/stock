...
from stock.stock.deprecated_serial_batch import (
	DeprecatedBatchNoValuation,
	DeprecatedSerialNoValuation,
)
from stock.stock.valuation import round_off_if_near_zero
...
class SerialBatchBundle:
	...
	def set_warehouse_and_status_in_serial_nos(self):
		from stock.stock.doctype.serial_no.serial_no import get_serial_nos as get_parsed_serial_nos
