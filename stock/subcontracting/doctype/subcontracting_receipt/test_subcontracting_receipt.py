...
class TestSubcontractingReceipt(FrappeTestCase):
	...
	def test_subcontracting_over_receipt(self):
		...
		"""
		from stock.controllers.subcontracting_controller import (
			make_rm_stock_entry as make_subcontract_transfer_entry,
		)
		from stock.subcontracting.doctype.subcontracting_order.subcontracting_order import (
			make_subcontracting_receipt,
		)
		from stock.subcontracting.doctype.subcontracting_order.test_subcontracting_order import (
			make_subcontracted_item,
		)
	...
	def test_subcontracting_receipt_gl_entry(self):
		...
		self.assertEqual(cint(stock.is_perpetual_inventory_enabled(scr.company)), 1)
	...
	def test_quality_inspection_for_subcontracting_receipt(self):
		from stock.stock.doctype.quality_inspection.test_quality_inspection import (
