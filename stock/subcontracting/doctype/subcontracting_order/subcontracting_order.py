...
from stock.buying.doctype.purchase_order.purchase_order import is_subcontracting_order_created
from stock.buying.utils import check_on_hold_or_closed_status
from stock.controllers.subcontracting_controller import SubcontractingController
...
class SubcontractingOrder(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from stock.subcontracting.doctype.subcontracting_order_item.subcontracting_order_item import (
			SubcontractingOrderItem,
		)
		from stock.subcontracting.doctype.subcontracting_order_service_item.subcontracting_order_service_item import (
			SubcontractingOrderServiceItem,
		)
		from stock.subcontracting.doctype.subcontracting_order_supplied_item.subcontracting_order_supplied_item import (
