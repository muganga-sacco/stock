...
def task(doc_name, from_doctype, to_doctype):
	...
	from stock.buying.doctype.purchase_order import purchase_order
	from stock.buying.doctype.supplier_quotation import supplier_quotation
	from stock.selling.doctype.quotation import quotation
	from stock.selling.doctype.sales_order import sales_order
	from stock.stock.doctype.delivery_note import delivery_note
	from stock.stock.doctype.purchase_receipt import purchase_receipt
