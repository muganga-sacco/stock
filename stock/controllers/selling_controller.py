...
from stock.controllers.sales_and_purchase_return import get_rate_for_return
from stock.controllers.stock_controller import StockController
from stock.stock.doctype.item.item import set_item_default
from stock.stock.get_item_details import get_bin_details, get_conversion_factor
...
class SellingController(StockController):
	...
	def validate_items(self):
		...
		from stock.controllers.buying_controller import validate_item_type
