...
import stock
from stock.controllers.accounts_controller import (
	validate_conversion_rate,
	validate_inclusive_tax,
	validate_taxes_and_charges,
)
from stock.stock.get_item_details import _get_item_tax_template
...
class calculate_taxes_and_totals(object):
	...
	def validate_conversion_rate(self):
		...
		company_currency = stock.get_company_currency(self.doc.company)
