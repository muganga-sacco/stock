...
from stock.accounts.doctype.payment_entry.payment_entry import get_payment_entry
from stock.accounts.party import get_due_date_from_template
...
from stock.controllers.accounts_controller import InvalidQtyError, update_child_qty_rate
...
class TestPurchaseOrder(FrappeTestCase):
	...
	def test_return_against_purchase_order(self):
		...
		from stock.stock.doctype.purchase_receipt.test_purchase_receipt import (
	...
	def test_purchase_order_invoice_receipt_workflow(self):
		from stock.accounts.doctype.purchase_invoice.purchase_invoice import make_purchase_receipt
	...
	def test_warehouse_company_validation(self):
		from stock.stock.utils import InvalidWarehouseCompany

		po = create_purchase_order(company="_Test Company 1", do_not_save=True)
		self.assertRaises(InvalidWarehouseCompany, po.insert)

	def test_uom_integer_validation(self):
		from stock.utilities.transaction_base import UOMMustBeIntegerError
	...
	def test_advance_payment_with_separate_party_account_enabled(self):
		...
		from stock.buying.doctype.purchase_order.purchase_order import make_purchase_invoice
	...
	def test_update_items_for_subcontracting_purchase_order(self):
		from stock.controllers.tests.test_subcontracting_controller import (
	...
	def test_po_billed_amount_against_return_entry(self):
		from stock.accounts.doctype.purchase_invoice.purchase_invoice import make_debit_note
