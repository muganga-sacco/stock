...
stock.buying.PurchaseOrderController = class PurchaseOrderController extends stock.buying.BuyingController {
	setup() {
	...
	get_items_from_open_material_requests() {
		stock.utils.map_current_doc({
			...
			get_query_method: "stock.stock.doctype.material_request.material_request.get_material_requests_based_on_supplier"
		});
	}
...
function set_schedule_date(frm) {
	if(frm.doc.schedule_date){
		stock.utils.copy_value_in_all_rows(frm.doc, frm.doc.doctype, frm.doc.name, "items", "schedule_date");
	}
}
