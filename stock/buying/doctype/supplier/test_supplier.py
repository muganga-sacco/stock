...
from stock.controllers.website_list_for_contact import get_customers_suppliers
from stock.exceptions import PartyDisabled
...
class TestSupplier(FrappeTestCase):
	...
	def test_serach_fields_for_supplier(self):
		from stock.controllers.queries import supplier_query
